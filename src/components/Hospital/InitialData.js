...
import { indicatorsUsedForNodeIdFetch, hospitalBedProfilesUsedForNodeId, nodeIdSelected } from '../../store/nodeData/nodeDataStore';
...
class InitialData extends React.Component {
    ...
    componentDidMount(){
        ...
        if (nodeId) {
            ...
            if (!this.props.hospitalBedProfilesIds) {
                this.props.hospitalBedProfilesForNodeIdFetch(nodeId);
            }
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    hospitalBedProfilesForNodeIdFetch: (nodeId) => {
        dispatch(hospitalBedProfilesUsedForNodeId({nodeId}));
    },
